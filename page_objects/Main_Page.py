...
class Main_Page(Base_Page):
    ...
    def get_temperature(self):
        ...
        result_flag = False 
        temperature = self.get_text(self.TEMPERATURE_FIELD).decode('utf-8')#used to decode from bytes to string
        if temperature is not None:
            ...
            try:
                temperature = int(temperature[0])#indexing of temperature is [0]
